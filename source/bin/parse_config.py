...
def parse_config(input_file, output_file, input_dir, output_dir, nifti_dir, bvec_dir, bval_dir):
    import os
    import json
    import glob
    import shutil
...
if __name__ == '__main__':
    ...
    ap.add_argument('--nifti_dir', default='/flywheel/v0/input/nifti', help='Full path to the nifti directory.')
    args = ap.parse_args()

    parse_config(args.input_file, args.output_file, args.input_dir, args.output_dir, args.nifti_dir, args.bvec_dir, args.bval_dir)
